            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Mrs. Isha Din-Gabisi', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ListTile(
                                          ...
                                          title: Text("Location"),
                                          subtitle: Text("Sierra Leone"),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.email),
                                          title: Text("Email"),
                                          subtitle: Text("dingabisi001@gmail.com"),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.phone),
                                          title: Text("Phone"),
                                          subtitle: Text("232-79-962-580"),
                                        ),
                                        ListTile(
